...
bone1vol=['C:\\Users\ajoshi\\Google Drive\\MRI and Ground Truth Images\\Volunteer2_VIBE_we.nii.gz'];
vatlas=load_nii(bone1vol);
bone1lab=['C:\\Users\ajoshi\\Google Drive\\MRI and Ground Truth Images\\Volunteer2_GroundTruth.nii.gz'];
...
%     vatlas_lab.img=vatlas_lab.img+v_lab.img;
    ...
    bonew=sprintf('C:\\Users\\ajoshi\\Google Drive\\MRI and Ground Truth Images\\Volunteer%d_VIBE_we.nii.gz',jj);
    vmov=load_nii(bonew);
    ...
    bone_lab=sprintf('C:\\Users\\ajoshi\\Google Drive\\MRI and Ground Truth Images\\Volunteer%d_GroundTruth.nii.gz',jj);
